...
from check_flag_main import RZD_flag, electricity_consumption_flag, Nominal_ruble_exchange_rate_flag, oil_price_flag, \
    CBR_polls_parser_flag, CBR_news_index_parser_flag
...
# update RZD file github
# Добавить фоновый режим к двум парсерам
# Убрать все принты
# Попробовать сохранить первую строку таблицы файла Х