...
last_date_in_table_manufacturer_prices_parser_flag = pd.to_datetime(df_X.dropna(subset=['Индекс цен производителей, в % к предыдущему месяцу']).iloc[-1]['date']).month
...
if last_date_in_table_manufacturer_prices_parser_flag + 1 < month_now:
