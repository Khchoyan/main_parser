...
if (last_date_in_table_RZD + 1 == month_now and update_date_dict_X['RZD'] <= day_now) or \
...
if last_date_in_table_oil_price_flag < month_now:
    oil_price_flag = True

if CBR_polls_parser_flag < month_now + 2:
    CBR_polls_parser_flag = True

if last_date_in_table_CBR_news_index_parser_flag < month_now:
    CBR_news_index_parser_flag = True

if last_date_in_table_CBR_invest_parser_flag < month_now + 1:
