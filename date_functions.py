...
def reformate_date(date, year):
    ...
    year = int(str(year).replace(')', '').replace('*', ''))
    flag = True if ((year % 4 == 0 and year % 100 != 0) or (year % 400 == 0)) else False
    if date == 'январь' or date == 'янв':
        date = '31 january'
    elif (date == 'февраль' or date == 'январь-февраль' or date == 'февр' or date == 'фев') and flag:
        date = '29 february'
    elif date == 'февраль' or date == 'январь-февраль' or date == 'февр' or date == 'фев':
        date = '28 february'
    elif date == 'март' or date == 'январь-март' or date == 'i квартал':
        date = '31 march'
    elif date == 'апрель' or date == 'январь-апрель' or date == 'апр':
        date = '30 April'
    elif date == 'май' or date == 'январь-май':
        date = '31 may'
    elif date == 'июнь' or date == 'январь-июнь' or date == 'i полугодие' or date == 'ii квартал' or date == 'июн':
        date = '30 june'
    elif date == 'июль' or date == 'январь-июль':
        date = '31 july'
    elif date == 'август' or date == 'январь-август' or date == 'авг':
        date = '31 august'
    elif date == 'сентябрь' or date == 'январь-сентябрь' or date == 'iii квартал' or date == 'сент' :
        date = '30 september'
    elif date == 'октябрь' or date == 'январь-октябрь' or date == 'окт':
        date = '31 october'
    elif date == 'ноябрь' or date == 'январь-ноябрь' or date == 'нояб':
        date = '30 november'
    elif date == 'декабрь' or date == 'январь-декабрь' or date == 'год' or date == 'год)' or date == 'iv квартал' or date == 'дек':
        date = '31 december'
